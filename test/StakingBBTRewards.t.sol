...
//         // Fund test users
//         token.transfer(user1, 23000 * 10**8);
...
//     function testEarnedAmount() public {
//         uint256 stakeAmount = 23000 * 10**8; // 1,000 tokens
...
//         // Get earned rewards
//         uint256 earnedRewards = stakingContract.earned(user1);
